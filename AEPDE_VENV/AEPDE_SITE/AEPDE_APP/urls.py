...
urlpatterns = [
    ...
    path('agregar_tarifa',agregar_tarifa, name="agregar_tarifa"),
    path('crear_oferta/<int:cod_producto>/', crear_oferta, name='crear_oferta'),
    path('reclamo',reclamo,name='reclamo'),
